...
if(isset($_POST['submit'])){
    ...
    $insertquery = "insert into py(name,email,timing)values('$name','$email','$timing')";
...
<!--cameras-->
<div class="trap"><center><h1>Syllabus we cover</h1></center></div>
<div class="row no-gutters">
    ...
    <div class="col-md-3 no-gutters"><h6><u>Python Date & Time</u></h6><br>Python datetime Module<br>Python datetime.strftime()<br>Python datetime.strptime()<br>Current date & time<br>Get current time<br>Timestamp to datetime
        <br>Python time Module<br>Python time.sleep()</div>
</div>
...
<div class="team-section">
    ...
    <div class="ps">
        <a href="#"><img src="img/sahil.jpg" alt="camera" class="thumnail"></a>
    </div>
</div>       

<div><center>Md.Sahil khan<br>B.Tech Computer Science</center></div>
<!--shirts-->
